...
/// <summary>
/// A GridManager class handles all the properties of the grid representing the map.
/// We'll keep a singleton instance of the GridManager class, as we need only one object
...
public class GridManager : MonoBehaviour {
    ...
    void Awake()
    {
        ...
        Debug.Log("Obstacle List Length=" + obstacleList.Length);
        CalculateObstacles();
    }

    //Find all the obstacles on map
    ...
    /// <summary>
    /// The GetGridCellCenter method returns the position of the grid cell in world
    /// coordinates from the cell index
    /// </summary>
    ...
    ///Another important method is GetNeighbours, which is used by the AStar class to
